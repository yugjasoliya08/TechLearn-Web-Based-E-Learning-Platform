...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Tech learn</h1>
        <p class="sub-text">Learn and Implement</p><br />
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i> Many Online Courses</h5>
          </div>
          <div class="col-sm">
		  ...
		  <div class="col-sm">
			<h5><i class="fas fa-rupee-sign mr-2"></i>Affordable Price</h5>
		</div>
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Tech learn provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Tech learn Pvt Ltd <br> Bhavnagar-364001<br> Ph.+919075846858 </p>
          </div>
        </div>
      </div>
